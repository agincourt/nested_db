  ...
  module Models
    module CallbackProcessing
      def self.included(base)
        ...
        base.class_eval do
          before_create :run_before_create_callbacks
          after_create  :run_after_create_callbacks
          before_update :run_before_update_callbacks
          after_update  :run_after_update_callbacks
          before_save   :run_before_save_callbacks
          after_save    :run_after_save_callbacks
        end
      end
      ...
      module InstanceMethods
        ...
        def run_before_update_callbacks
          run_taxonomy_callbacks :before_update
        end
        
        def run_after_update_callbacks
